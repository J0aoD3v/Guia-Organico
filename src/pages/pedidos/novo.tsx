        ...
        <main style={{ maxWidth: 800, margin: "30px auto", padding: 20 }}>
          ...
          <div style={{ marginBottom: "24px" }}>
            <h2 style={{ margin: "0 0 8px 0" }}>
              📋 Solicitar Autorização de Insumo
            </h2>
            <p style={{ color: "#6b7280", margin: 0 }}>
              Preencha as informações abaixo para solicitar a autorização de um
              novo insumo orgânico.
            </p>
          </div>
          ...
          {!enviado ? (
            ...
            >
                  ...
                  <div>
                    ...
                    {fichaFile && (
                      <span style={{ color: "#16a34a" }}>
                        Arquivo selecionado: {fichaFile.name}
                      </span>
                    )}
                  </div>
                  <div>
                    ...
                    {bulaFile && (
                      <span style={{ color: "#16a34a" }}>
                        Arquivo selecionado: {bulaFile.name}
                      </span>
                    )}
                  </div>
                </div>
              ...
              <div style={{ margin: "16px 0" }}>
                ...
                >
                  ...
                  />
                  Quero receber avisos de atualizações por e-mail (
                  {session?.user?.email})
                </label>
              </div>
            ...
            >
              ...
              <h2 style={{ color: "#166534", marginBottom: "12px" }}>
              ...
              >
                Agora é só aguardar. Nossa equipe irá analisar sua solicitação e
                indicar a melhor certificadora disponível para você.
              </p>
              <p style={{ color: "#374151", marginBottom: "16px" }}>
                Você receberá atualizações por e-mail ({session?.user?.email}).
                <br />
                Caso queira enviar documentos, encaminhe para{" "}

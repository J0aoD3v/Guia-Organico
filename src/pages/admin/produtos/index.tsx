...
export default function ProdutosAdmin() {
  ...
  useEffect(() => {
    if (categoriaSelecionada) {
      ...
      fetchProdutosPorCategoria(categoriaSelecionada);
    } else {
      fetchProdutos();
    }
  ...
  const fetchProdutosPorCategoria = async (categoria) => {
  ...
  const excluirCategoria = async (id) => {
    if (!confirm("Excluir categoria e todos os produtos nela?")) return;
    const res = await fetch("/api/categorias", {
      method: "DELETE",
      headers: { "Content-Type": "application/json" },
    ...
    <div>
      ...
      >
              ...
              <form onSubmit={handleAddProduto}>
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, certificacao: e.target.value })
                    }
                    style={{
                      width: "100%",
                      padding: "8px",
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        classeAgronomica: e.target.value,
                      })
                    }
                    style={{
                      width: "100%",
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, composicao: e.target.value })
                    }
                    style={{
                      width: "100%",
                      padding: "8px",
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, modoUso: e.target.value })
                    }
                    style={{
                      width: "100%",
                      padding: "8px",
                ...
                <div style={{ marginBottom: "16px" }}>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, precaucoes: e.target.value })
                    }
                    style={{
                      width: "100%",
                      padding: "8px",
        ...
        <div style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 22, fontWeight: "bold" }}>Categorias</h2>
          ...
          <ul
            style={{ listStyle: "none", padding: 0, display: "flex", gap: 12 }}
          >
            {categorias.map((cat) => (
              <li key={cat._id}>
                <button
                  style={{
                    background:
                      categoriaSelecionada === cat.nome ? "#3b82f6" : "#f3f4f6",
                    color: categoriaSelecionada === cat.nome ? "white" : "#111",
                    border: "none",
                    borderRadius: 6,
                    padding: "6px 12px",
                    cursor: "pointer",
                  ...
                  >
                    ...
                    <td style={{ padding: 12 }}>
                      <span
                        style={{
                          background:
                            produto.status === "ativo" ? "#dcfce7" : "#fef2f2",
                          color:
                            produto.status === "ativo" ? "#166534" : "#dc2626",
                          padding: "4px 8px",
                          borderRadius: "4px",
                          fontSize: "12px",
                          fontWeight: "500",
                    ...
                    >
                      ...
                      <div style={{ fontSize: "11px", color: "#9ca3af" }}>
                        {produto.origem === "pedido_aprovado"
                          ? "Via pedido"
                          : "Manual"}
                      </div>
                    </td>
                    <td style={{ padding: 12, textAlign: "center" }}>
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleDeleteProduct(produto._id, produto.nome)
                          }
